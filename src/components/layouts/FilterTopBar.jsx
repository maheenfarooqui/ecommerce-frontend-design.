  ...
  return (
    <div className="w-full bg-white border border-gray-200 rounded-lg p-3 flex items-center justify-between mb-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <label className="flex items-center gap-2 text-[16px] text-[#1C1C1C] cursor-pointer select-none">
          <input type="checkbox" className="w-4 h-4 accent-blue-600" defaultChecked />
          <span>Verified only</span>
        </label>

        {/* Sorting Dropdown */}
        <select className="border border-gray-300 rounded-md p-1.5 bg-white text-[15px] text-[#1C1C1C] outline-none">
        ...
        <div className="flex border border-gray-300 rounded-md overflow-hidden">
          ...
          <button 
            ...
            className={`p-2 cursor-pointer border-none transition-colors ${
              view === 'grid' ? 'bg-gray-100 text-[#1C1C1C]' : 'bg-white text-gray-400 hover:text-gray-600'
            }`}
          >
          ...
          <button 
            ...
            className={`p-2 cursor-pointer border-none border-l border-gray-300 transition-colors ${
              view === 'list' ? 'bg-gray-100 text-[#1C1C1C]' : 'bg-white text-gray-400 hover:text-gray-600'
            }`}
          >
