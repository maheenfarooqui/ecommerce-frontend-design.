  ...
  return (
    <div className="w-full bg-[#F7FAFC] py-5">
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 bg-white p-4 rounded-xl border border-gray-200">
                ...
                <li key={idx}>
                  <a
                    ...
                    style={{ 
                      ...
                      backgroundColor: item === 'Automobiles' ? '#E5F1FF' : 'transparent',
          ...
          {/* 2. CENTER: Main Banner (Mobile par full width, Desktop par 2 columns leta hy) */}
          <div 
            className="col-span-1 lg:col-span-2 rounded-lg p-8 flex flex-col justify-center relative min-h-[300px] lg:min-h-full bg-cover bg-center"
            style={{ 
      ...
      />
            ...
            <div className="bg-[#F38332] p-4 rounded-lg text-white flex flex-col justify-center min-h-[95px]">
              <p className="text-[15px] m-0 leading-snug font-normal max-w-[150px]">
                Get US $10 off with a new supplier
              </p>
            </div>

            {/* Bottom Widget: Cyan Promo */}
            <div className="bg-[#55BDB3] p-4 rounded-lg text-white flex flex-col justify-center min-h-[95px]">
              <p className="text-[15px] m-0 leading-snug font-normal max-w-[150px]">
