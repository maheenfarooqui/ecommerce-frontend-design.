...
export default function RegionSuppliersSection() {
  return (
    <div className="w-full bg-bg-gray pb-12">
      <Container>
        {/* Section Title */}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-y-5 gap-x-4">
          {regionsData?.map((region) => (
            ...
            >
              ...
              <div className="w-7 h-5 overflow-hidden border border-gray-100 shrink-0 mt-0.5">
                <img
                  src={region.flag}
                  alt={region.name}
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-[15px] text-dark-main font-normal leading-tight group-hover:text-[#0D6EFD] transition-colors truncate">
                  {region.name}
                </span>
