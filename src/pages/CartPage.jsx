...
export default function CartPage() {
  ...
  return (
    <div className="w-full bg-bg-gray min-h-screen py-6 box-border select-none text-left">
      <Container>
        {/* Dynamic Title Headers count row */}
        <h1 className="text-[24px] font-bold text-dark-main m-0 mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="lg:col-span-2 flex flex-col gap-0 border border-gray-200 bg-white rounded-sm shadow-sm overflow-hidden">
            {cartItems.length === 0 ? (
              ...
              <div className="p-5 flex flex-col gap-5">
                {cartItems.map((item) => (
                  <div
                    key={item.id}
                    className="flex flex-col sm:flex-row gap-4 justify-between items-start border-0 border-b border-gray-100 pb-5 last:border-none last:pb-0"
                  >
                    {/* Item parameters core row display components */}
                    <div className="flex gap-4 min-w-0">
                      <div className="w-20 h-20 border border-gray-200 rounded-sm p-1.5 flex items-center justify-center shrink-0 mix-blend-multiply bg-white">
                        <img
                          src={item.img}
                          alt={item.title}
                      ...
                      <div className="flex flex-col min-w-0">
                        <h3 className="text-[16px] font-medium text-dark-main m-0 leading-snug truncate sm:whitespace-normal sm:line-clamp-2">
                          {item.title}
                        </h3>
                    ...
                    <div className="flex sm:flex-col items-end justify-between sm:justify-start w-full sm:w-auto shrink-0 gap-3">
                      ...
                      <select
                        ...
                        className="w-25 h-9 border border-gray-300 rounded-sm bg-white outline-none px-2 font-normal text-[15px] cursor-pointer text-dark-main"
                      >
                        {[...Array(10)].map((_, idx) => (
                ...
                <div className="flex items-center justify-between border-0 border-t border-gray-100 pt-4 mt-2">
                  <Link
                    to="/products"
                    className="h-10 px-4 bg-[#0D6EFD] hover:bg-blue-700 text-white font-medium text-[15px] rounded-lg shadow-sm flex items-center gap-2 no-underline cursor-pointer transition-colors"
                  >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white border border-gray-200 rounded-sm p-4 box-border shadow-sm flex flex-col gap-2">
              ...
              <div className="flex border border-gray-300 rounded-lg overflow-hidden h-10">
                <input
                  ...
                  className="flex-1 px-3 border-none outline-none text-[15px] bg-white text-dark-main"
                />
            ...
            <div className="bg-white border border-gray-200 rounded-sm p-5 box-border shadow-sm flex flex-col gap-3">
              <div className="flex justify-between text-[16px]">
                <span className="text-[#505050]">Subtotal:</span>
                <span className="text-dark-main">${subtotal.toFixed(2)}</span>
              </div>
              <div className="flex justify-between text-[16px]">
              ...
              <div className="flex justify-between text-[18px] font-semibold text-dark-main">
                <span>Total:</span>
              ...
              <div className="flex items-center justify-center gap-2 mt-2 opacity-70">
                <span className="border border-gray-200 px-2 py-0.5 rounded text-[11px] font-bold text-blue-900 bg-gray-50">
                  AMEX
                </span>
                <span className="border border-gray-200 px-2 py-0.5 rounded text-[11px] font-bold text-orange-600 bg-gray-50">
                  MC
                </span>
                <span className="border border-gray-200 px-2 py-0.5 rounded text-[11px] font-bold text-blue-600 bg-gray-50">
                  PAYPAL
                </span>
                <span className="border border-gray-200 px-2 py-0.5 rounded text-[11px] font-bold text-blue-800 bg-gray-50">
                  VISA
                </span>
                <span className="border border-gray-200 px-2 py-0.5 rounded text-[11px] font-bold text-black bg-gray-50">
                  APPLE PAY
                </span>
              </div>
            </div>
